...
//	消息的id
	...
	public String getNotice_courseName() {
		return notice_courseName;
	}

	public void setNotice_courseName(String notice_courseName) {
		this.notice_courseName = notice_courseName;
	}
	...
	public String toString() {
		return "Notice [id=" + id + ", notice_courseid=" + notice_courseid + ", notice_time=" + notice_time
				...
				+ ", timeout=" + timeout + ", notice_courseName=" + notice_courseName + "]";
	}
