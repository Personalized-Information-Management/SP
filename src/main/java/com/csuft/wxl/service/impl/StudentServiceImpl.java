...
public class StudentServiceImpl implements StudentService {
	...
	public int getStudentStudysCourse_count(Student student) {
		// TODO Auto-generated method stub
		return studentmap.selecStudyCourse_count(student);
	}

	@Override
	public int getStudentFinishCourse_count(Student student) {
		// TODO Auto-generated method stub
		return studentmap.selectFinishCourseById_count(student);
	}

	@Override
	public int getStudentCollectCourse_count(Student student) {
		// TODO Auto-generated method stub
		return studentmap.selectCollectCourseById_count(student);
	}
