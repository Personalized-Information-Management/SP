...
<body>
	<div class="container-fluid"
		style="padding: 0px; vertical-align: center">
		<div class="nav col-12"
			style="background: rgb(71, 62, 62); height: 50px;">
			<div class="container">
	...
	<div id="app" class="container">
		...
		<br> <br> <br> <br> <br>
		<div class="card col-sm-6 col-md-6 col-lg-4  offset-sm-3 offset-lg-4"
			...
			<form action="/login" method="post" style="text-align: center">
				<input style="display: none;" type="text" class="form-control"
					v-model="role" name="role"> <input type="text"
					class="form-control" v-model="name" name="name" placeholder="输入账号"
					pattern="[0-9]*" title="仅数字" required="required"> <br>
				<input type="password" class="form-control" v-model="password"
					name="password" placeholder="输入密码" pattern="[0-9]*[a-z]*[A-Z]*[_]*"
					required="required" title="大小写字母，数字，或下划线的组合"> <br>
	...
	<nav class="navbar-nav fixed-bottom "
		style="color: white; background: #000; height: 50px;">
