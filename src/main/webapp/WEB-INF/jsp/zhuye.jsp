			...
			<div class="container">
				...
				<div class="row my-1 col-lg-10">
					<div class="col-lg-2 col-md-4  col-sm-4 col-6" style="text-align: center;">
						<a href="/persion"><img style="width: 100px;" src="/img/个人信息.png" alt="">
							<p>个人信息</p>
						</a>
					</div>
					<div class="col-lg-2 col-md-4 col-sm-4 col-6 " style="text-align: center;">
						<a href="/course/studying"> <img style="width: 100px;" src="/img/课程管理.png" alt="">
							<p>正在学习</p>
						</a>
					</div>
					<div class="col-lg-2 col-md-4 col-sm-4 col-6" style="text-align: center;">
						<a href="/dis"> <img style="width: 100px;" src="/img/作业.png" alt="">
							<p>消息</p>
						</a>
					</div>
					<div class="col-lg-2 col-md-4 col-sm-4 col-6" style="text-align: center;">
