                                ...
                                <td class="px-4 pt-5">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button id="removestudy" class="btn btn-primary"
                                                    @click="removestudy">取消学习</button>
                                            </td>
                                        </tr>
                                    </table>
                                    <br>
        ...
        var app = new Vue({
            ...
            methods: {
                removestudy: function () {
                    if (this.data.id != '') {
                        document.getElementById("removestudy").disabled = true;
                        var formDate = new FormData();
                        formDate.append("course_id", this.data.id)
                        axios.post("/course/studyoff-req", formDate)
                            .then(res => {
                                ...
                                document.getElementById("removestudy").disabled = false;
                                location.href="/course/studying"
                            })
                            .catch(err => {
                                alert("添加失败")
                                document.getElementById("removestudy").disabled = false;
