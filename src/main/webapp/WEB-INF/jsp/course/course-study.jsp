            ...
            <div class="container ">
              <ul class="navbar-nav mr-auto row mt-2 mt-lg-0">
                <li class="nav-item active">
                  <a class="nav-link" href="http://localhost:8080/zhuye">主页</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course">课程</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">作业</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">成长</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">教师通知</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">讨论区</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">活动</a>
                </li>
                <li>
                  <a class="nav-link" href="http://localhost:8080/course#">切换账号</a>
                </li>
                <li>
                  <a class="nav-link " href="http://localhost:8080/course#">退出登录</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container-fluid mt-lg-4">
        <div class="row">
          ...
          <div class="list-group col-lg-2 col-sm-2 my-3">
            ...
            <a href="/course/studying" class="list-group-item list-group-item-action active">正在学习</a>
      ...
      'v-card',
      {
        ...
        <a :href="'/course/details?cid='+subject.id" class="panel  alert-success row py-1 my-2" >
            ...
            <table class="mt-3 col-4  ">
			 ...
			 <a :href="'/course/details-continue?cid='+subject.id" class="btn col-3 offset-1 u-font mt-4 mb-4" style="background: rgb(101, 147, 74);">继续学习</a>
      </div>
          </a>
              `
      })
