...
<body>
        ...
        <div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 pt-5">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <button id="removeshoucang" class="btn btn-outline-danger btn-sm"
                                                    @click="removeshoucang">取消收藏☆</button>
                                            </td>
                                            <td>
            ...
            <div class="jumbotron">
                <div class="row">
                    ...
                    <a :href='"/course/display?cid="+data.id' class="nav-link mb-1">进入课程</a>
                </div>
                <hr class="my-2">
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data: data,
            methods: {
                removeshoucang: function () {
                    if (this.data.id != '') {
                        document.getElementById("removeshoucang").disabled = true;
                        var formDate = new FormData();
                        formDate.append("course_id", this.data.id)
                        axios.post("/course/collectoff-req", formDate)
                            .then(res => {
                                ...
                                document.getElementById("removeshoucang").disabled = false;
                                location.href = "/course/collect"
                            })
                            .catch(err => {
                                alert("取消收藏失败")
                                document.getElementById("removeshoucang").disabled = false;
