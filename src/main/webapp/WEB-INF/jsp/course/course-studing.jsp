      ...
      'v-card',
      {
        ...
        <a :href="'/course/details?cid='+subject.id" class="panel  alert-success row py-1 my-2" >
            ...
            <table class="mt-3 col-4  ">
			 ...
			 <a :href="'/course/details1?cid='+subject.id" class="btn col-3 offset-1 u-font mt-4 mb-4" style="background: rgb(101, 147, 74);">取消学习</a>
      </div>
          </a>
              `
      })
    ...
    var m = new Vue(
      {
        ...
        methods: {
          fun: function (elem) {
            var url1 = "/course/details1?cid=" + elem.currentTarget.firstElementChild.innerHTML;
